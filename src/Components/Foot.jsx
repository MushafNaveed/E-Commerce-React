...
import svg7 from "../images/envelope-outline.svg"
import img12 from "../images/sofa.png"
                ...
                <div className="border-top copyright">
                    <div className="row pt-4">
                        <div className="col-lg-6">
                            <p className="mb-2 text-center text-lg-start">Copyright &copy; 2024. All Rights Reserved. &mdash; Designed By MN.
            </p>
                        </div>
